  ...
  return (
    <>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-9 py-4 text-base rounded-xl bg-green-600/20 text-white hover:bg-green-600/30 backdrop-blur-sm border border-green-500/30 font-semibold transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service) => (
              <Link key={service.title} href={service.href}>
                <a className="glass-card p-8 group hover:border-primary-500/30 transition-all duration-500 hover:premium-shadow block">
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?w=1920&h=900&fit=crop"
